...
public class PlayerMovement : SingletonPlayer<PlayerMovement>
{
    ...
    private void Update()
    {
        if (!PlayerInputIsDisabled)
        {
            ...
            EventHandle.CallMovementEvent(xInput, yInput, isWalking, isRunning, isSprinting, isSlowingDown, isIdle, isCarrying, toolEffect, false, false);
        }
    }
    ...
    private void PlayerMovementInput()
    {
        ...
        if (xInput != 0 || yInput != 0)
        {
            ...
            {
                Debug.Log("isslowingdown = true");
                isRunning = false;
                isWalking = false;
                isRunning = false;
                movementSpeed = SettingsStats.slowingDownSpeed;
            }
            //isRunning = false;
            //isSprinting = false;
            //isWalking = true;

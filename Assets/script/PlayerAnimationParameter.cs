...
public class PlayerAnimationParameter : MonoBehaviour
{
    ...
    private void SetAnimationParameter(float xInput, float yInput, bool isWalking, bool isRunning, bool isSprinting, bool isSlowingDown, bool isIdle, bool isCarrying, ToolEffect toolEffect, bool idleLeft, bool idleRight)
    {
        ...
        animator.SetBool(SettingsStats.isSlowingDown, isSlowingDown);
